...
module OpenapiClient
  class JokesApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :body Post the joke as plain text.
    # @return [Array<(AnalyzeJoke200Response, Integer, Hash)>] AnalyzeJoke200Response data, response status code and response headers
    def analyze_joke_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AnalyzeJoke200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['apiKey']

      new_options = opts.merge(
        :operation => :"JokesApi.analyze_joke",
    ...
    def downvote_joke_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/jokes/{id}/downvote'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"JokesApi.downvote_joke",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [Integer] :min_rating The minimum rating between 0 and 10 the result should have.
    # @option opts [Integer] :max_length The maximum number of letters in the joke.
    # @return [Array<(RandomJoke200Response, Integer, Hash)>] RandomJoke200Response data, response status code and response headers
    def random_joke_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RandomJoke200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['apiKey']

      new_options = opts.merge(
        :operation => :"JokesApi.random_joke",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def search_jokes_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JokesApi.search_jokes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def submit_joke_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"JokesApi.submit_joke",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def upvote_joke_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/jokes/{id}/upvote'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"JokesApi.upvote_joke",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
