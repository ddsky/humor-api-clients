...
module OpenapiClient
  class OtherApi
    ...
    # @param reason [String] The reason for the praise/insult.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Praise200Response, Integer, Hash)>] Praise200Response data, response status code and response headers
    def insult_with_http_info(name, reason, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Praise200Response'
    ...
    # @param word [String] The word to be rated.
    # @param [Hash] opts the optional parameters
    # @return [Array<(RateWord200Response, Integer, Hash)>] RateWord200Response data, response status code and response headers
    def rate_word_with_http_info(word, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RateWord200Response'
