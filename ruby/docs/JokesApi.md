...
begin
  ...
  puts "Exception when calling JokesApi->downvote_joke: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling JokesApi->random_joke: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling JokesApi->search_jokes: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling JokesApi->submit_joke: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling JokesApi->upvote_joke: #{e}"
end
```
