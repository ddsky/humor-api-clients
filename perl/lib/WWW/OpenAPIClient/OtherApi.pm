...
sub insult {
    ...
    my $_response_object = $self->{api_client}->deserialize('Praise200Response', $response);
    return $_response_object;
}
...
sub rate_word {
    ...
    my $_response_object = $self->{api_client}->deserialize('RateWord200Response', $response);
    return $_response_object;
}
