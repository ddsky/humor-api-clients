...
class MemesApi
{
     ...
     */
    public function downvoteMemeRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function randomMemeRequest($keywords = null, $keywords_in_image = null, $media_type = null, $number = null, $min_rating = null)
    {
        ...
        if ($keywords_in_image !== null) {
            if('form' === 'form' && is_array($keywords_in_image)) {
                foreach($keywords_in_image as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
        ...
        // query params
        if ($media_type !== null) {
            if('form' === 'form' && is_array($media_type)) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchMemesRequest($keywords = null, $keywords_in_image = null, $media_type = null, $number = null, $min_rating = null, $offset = null)
    {
        if ($number !== null && $number > 10) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function upvoteMemeRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
