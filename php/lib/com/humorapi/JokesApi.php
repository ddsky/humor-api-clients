...
class JokesApi
{
     ...
     */
    protected function analyzeJokeRequest($body = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function downvoteJokeRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function randomJokeRequest($keywords = null, $include_tags = null, $exclude_tags = null, $min_rating = null, $max_length = null)
    {
        if ($min_rating !== null && strlen($min_rating) < 0) {
            throw new \InvalidArgumentException('invalid length for "$min_rating" when calling JokesApi.randomJoke, must be bigger than or equal to 0.');
        }
        ...
        if ($include_tags !== null) {
            $queryParams['include-tags'] = ObjectSerializer::toQueryValue($include_tags);
        }
        // query params
        if ($exclude_tags !== null) {
            $queryParams['exclude-tags'] = ObjectSerializer::toQueryValue($exclude_tags);
        }
        // query params
        if ($min_rating !== null) {
    ...
    protected function searchJokesRequest($keywords = null, $include_tags = null, $exclude_tags = null, $number = null, $min_rating = null, $max_length = null)
    {
        ...
        if ($min_rating !== null && strlen($min_rating) < 0) {
            throw new \InvalidArgumentException('invalid length for "$min_rating" when calling JokesApi.searchJokes, must be bigger than or equal to 0.');
        }
        if ($min_rating !== null && $min_rating > 10) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function submitJokeRequest($body = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function upvoteJokeRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
