...
class GenerateNonsenseWord200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generate_nonsense_word_200_response';
    ...
    */
    ...
    public function setWord($word)
    {
        ...
        if ((mb_strlen($word) < 1)) {
            throw new \InvalidArgumentException('invalid length for $word when calling GenerateNonsenseWord200Response., must be bigger than or equal to 1.');
        }
