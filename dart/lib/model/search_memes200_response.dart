...
class SearchMemes200Response {
  ...
  Set<SearchMemes200ResponseMemesInner> memes;
  ...
  @override
  String toString() => 'SearchMemes200Response[memes=$memes]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'memes'] = this.memes.toList(growable: false);
    return json;
  }
  ...
  static SearchMemes200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SearchMemes200Response(
        memes: SearchMemes200ResponseMemesInner.listFromJson(json[r'memes']).toSet(),
      );
    }
    return null;
  }
