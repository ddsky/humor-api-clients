...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = JokesApi()
        api_instance.analyze_joke  # this is an instance of the class Endpoint
        api_instance.analyze_joke()  # this invokes api_instance.analyze_joke.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.analyze_joke.callable or self.callable in this class
