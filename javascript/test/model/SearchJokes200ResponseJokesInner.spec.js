...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HumorApi.SearchJokes200ResponseJokesInner();
  });
  ...
  describe('SearchJokes200ResponseJokesInner', function() {
    it('should create an instance of SearchJokes200ResponseJokesInner', function() {
      ...
      //var instance = new HumorApi.SearchJokes200ResponseJokesInner();
      //expect(instance).to.be.a(HumorApi.SearchJokes200ResponseJokesInner);
    });
