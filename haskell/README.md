## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Humor API`
...
| Humor.Core      | core functions, config and request types            |
