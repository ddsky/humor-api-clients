...
-- model import
local humorapi_inline_response_200_2 = require "humorapi.model.inline_response_200_2"
local humorapi_inline_response_200_3 = require "humorapi.model.inline_response_200_3"
...
function memes_api:random_meme(keywords, keywords_in_image, media_type, Number_, min_rating)
	...
	if http_status:sub(1,1) == "2" then
		...
		return humorapi_inline_response_200_3.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
...
function memes_api:search_memes(keywords, keywords_in_image, media_type, Number_, min_rating, offset)
	...
	if http_status:sub(1,1) == "2" then
		...
		return humorapi_inline_response_200_2.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
