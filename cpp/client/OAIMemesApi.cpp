...
void OAIMemesApi::downvoteMemeCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT downvoteMemeSignal(output);
        Q_EMIT downvoteMemeSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT downvoteMemeSignalE(output, error_type, error_str);
        Q_EMIT downvoteMemeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT downvoteMemeSignalError(output, error_type, error_str);
        Q_EMIT downvoteMemeSignalErrorFull(worker, error_type, error_str);
    }
}
...
void OAIMemesApi::randomMemeCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIRandom_meme_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIMemesApi::searchMemesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAISearch_memes_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIMemesApi::upvoteMemeCallback(OAIHttpRequestWorker *worker) {
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT upvoteMemeSignal(output);
        Q_EMIT upvoteMemeSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT upvoteMemeSignalE(output, error_type, error_str);
        Q_EMIT upvoteMemeSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT upvoteMemeSignalError(output, error_type, error_str);
        Q_EMIT upvoteMemeSignalErrorFull(worker, error_type, error_str);
    }
}
